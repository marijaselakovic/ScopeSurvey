...
set yrange [0:9]
dx = 1/5.0
plot 'data1.dat' using 2:xtic(1) title col lc rgb "orange", '' using 3 title col lc rgb "blue", '' u 0:2:2 with labels center offset -11,0.7 notitle, '' u 0:3:3 with labels center offset -7,0.7 notitle
